...
it("parses seasons of demon slayer", async () => {
  ...
  let expected: any = [
    {
      id: "GR5VCD239",
      title: "S1 - Demon Slayer: Kimetsu no Yaiba",
      slug_title: "demon-slayer-kimetsu-no-yaiba",
      season_number: null,
      audio_locale2: "RU",
    ...
    {
      id: "GY09CX3E8",
      title: "Movie - Demon Slayer -Kimetsu no Yaiba- The Movie: Mugen Train",
      slug_title: "demon-slayer--kimetsu-no-yaiba--the-movie-mugen-train",
      season_number: null,
      audio_locale2: "EN",
    ...
    {
      id: "GRX0C4D5Q",
      title: "S2 Part 1 - Demon Slayer: Kimetsu no Yaiba Mugen Train Arc",
      slug_title: "demon-slayer-kimetsu-no-yaiba-mugen-train-arc",
      season_number: null,
      audio_locale2: "EN",
    ...
    },
    {
      id: "G6P8CX023",
      title:
        "S2 Part 2 - Demon Slayer: Kimetsu no Yaiba Entertainment District Arc",
      slug_title: "demon-slayer-kimetsu-no-yaiba-entertainment-district-arc",
      season_number: null,
      audio_locale2: "EN",
